            ...
            case 'purchase_gst':
                queryStr = `
                    SELECT 
                        ...
                        pb.overall_discount_percent,
                        pb.overall_discount_amount,
                        pb.taxable_amount,
                        CASE 
                            WHEN pb.tax_type = 'CSGST' THEN pb.total_gst_amount / 2
                            ELSE 0
                        END as cgst_amount,
                        CASE 
                            WHEN pb.tax_type = 'CSGST' THEN pb.total_gst_amount / 2
                        ...
                        END as sgst_amount,
                        CASE 
                            WHEN pb.tax_type = 'IGST' THEN pb.total_gst_amount
                            ELSE 0
                        END as igst_amount,
                        pb.total_gst_amount,
                        pb.grand_total
                    ...
                    AND DATE(pb.bill_date) BETWEEN ? AND ?
